...
*Sources: [OpenAI pricing](https://openai.com/api/pricing/), [Anthropic models](https://platform.claude.com/docs/en/about-claude/models/overview), [Google AI pricing](https://ai.google.dev/pricing), [xAI pricing](https://docs.x.ai/docs/models#models-and-pricing), [DeepSeek pricing](https://api-docs.deepseek.com/quick_start/pricing), [Together.ai](https://www.together.ai/pricing), [Groq](https://groq.com/pricing) for open-source model hosting. All checked February 19, 2026.*
